        ...
        <div class="row" style="margin: 1em">
            ...
            <div class="col-md-6">
                ...
                <p style="font-size: 1em">
                    ...
                    joueurs encore.
                    <br><br>
                    Pas de mod, pas de plugin, juste du Minecraft Vanilla, toujours en dernière version. C'est une
                    aventure qui se veut la plus proche possible de l'expérience de jeu originale.
                    <br><br>
                    Le plaisir de la découverte, de la construction, de l'exploration, de la survie, de la coopération,
                    de la compétition, de l'entraide !
                </p>
                <br>
                <script>
                    if (!(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))) {
